""""
    ...
    The dataset consists of aerial imagry of Dubai obtained from MBRSC satellites and annoted with pizel-wise semantic segmentation into 6 classes. 
    ...
    Tile 2: 509 x 544 --> 512 x 512 --> 2
    Tile 3: 62 x 658 --> 512 x 512 --> 4
    ...
    Total 1305 patches of size 256 x 256
...
root_directory = 'D:\Kaggle\Semantic Segmentation Dataset\Semantic segmentation dataset/'
...
This numbe divided by sixteen (integer division; ignoring any remainder) gives the first hexadecimal digit 
(between 0 and F, where the letters A to F represent the numbers 10 to 15).
The remainder gives the second haxadecimal digit.
0-9 --> 0-9
10-15--> A-F
...
# if matches then replace all values in that pixel with a specified integer

def rgb_to_2D_label(label):
    
    """
    Supply our labe;s masks as input in RGB format. 
